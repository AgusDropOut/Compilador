...
String funcID = $1.sval; // Clave completa (ej: F:MAIN)
...
| TRUNC '(' '-' CTE ')' { yyerror("Error: no se admiten constantes negativas en el cuerpo del trunc"); }
;
